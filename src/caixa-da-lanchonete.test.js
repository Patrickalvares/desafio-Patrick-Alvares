...
describe("CaixaDaLanchonete", () => {
  ...
  test.each([
    ...
    ["cafe e chantily", "credito", "R$ 4,63", ["cafe,1", "chantily,1"]],
    ["sanduiche e queijo", "debito", "R$ 8,50", ["sanduiche,1", "queijo,1"]],
    ["quantidade negativa", "dinheiro", "Quantidade inválida!", ["cafe,-1"]],
    ["grandes quantidades", "debito", "R$ 300,00", ["cafe,100"]],
    [
      "itens repetidos no carrinho",
      "dinheiro",
      "R$ 5,70",
      ["cafe,1", "cafe,1"],
    ],
